...
int main(int argc, char *argv[]) {
    ...
    g_object_set(source, "location", "rtsp://192.168.0.145:8554/xx", "timeout", (guint64)30 * GST_SECOND, NULL);
    ...
    gst_rtsp_media_factory_set_launch(factory, "( rtspsrc location=rtsp://192.168.0.145:8554/xx ! rtph264depay ! avdec_h264 ! videoconvert ! x264enc ! rtph264pay name=pay0 pt=96 )");
